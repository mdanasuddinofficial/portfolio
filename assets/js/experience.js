...
const exp = [
  ...
  },
  {
    ...
    cardImage: "assets/images/experience-page/r2.jpg",
    place: "Youtube & Google",
    time: "(2020 - present)",
    desp: "<li>Git</li> <li>GitHub</li> <li>VS Code</li> <li>Linux</li>",
  },
  {
    title: "Designing",
    cardImage: "assets/images/experience-page/r3.jpg",
    place: "Self Learning",
    time: "(2020 - present)",
    desp: "<li>Adobe Photoshop</li> <li>Adobe Illustrator</li> <li>Canva</li>",
  },
];
/* */
const showCards2 = () => {
